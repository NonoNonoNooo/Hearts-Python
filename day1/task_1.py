...
def probability_meeting_symbol(string: str) -> dict:
    ...
    Аргументи:
    - string (str): Вхідний рядок для аналізу.

    Повертається:
    - dict: Словник, де ключі представляють унікальні символи у рядку,
      а значення - ймовірність зустрічі кожного символу у рядку
      виражену у відсотках, округлених до двох десяткових знаків.
    """
